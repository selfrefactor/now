const { shuffle, defaultTo, random, getter } = require('rambdax')

export const PADDING = ';padding:7px 6px;'
export const fontColors = shuffle([
  '#fafafa',
  '#faefe0',
  '#f9f6f1',
  '#f9f6f1',
...
// Colorized logs
// ============================================
export function colorLog(logIndex, label, input){
...
export function logString(input){
  const colorMode = 'background: #aa769b; color: #ebe6d9;padding: 6px'
